...
> **用途**: 软件工程标准图表的「工具箱」——user-journey-flows.md 之外的补充图表，按项目实际需求选用。
...
| 想表达什么 | 用什么图 | 放哪 | 何时需要 |
|:--------|:--------|:----|:--------|
| 业务闭环/流程走向 | 旅程总览 + 泳道流程图 | `user-journey-flows.md` | 必写 |
| 跨系统时序交互 | 时序图 | `user-journey-flows.md` | 有第三方/多系统 |
| 对象生命周期 | 状态图 | `user-journey-flows.md` | 有状态机 |
